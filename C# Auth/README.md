...
[скачать архив](https://github.com/gKonstantin17/prog-templates/releases/tag/c%23-auth)

### Настройка БД

PostgreSQL, в которой пустая бд с названием `auth-sharp`, пользователь: `postgres`, пароль: `rootroot`.
...
При миграции будет создан пользователь ролью `Admin`
